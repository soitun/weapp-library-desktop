...
export function sendCode(phone, forRegister = false) {
  if (forRegister) {
    return fetch.post("/api/libraries/vrcode/register", { phone });
  } else {
    return fetch.post("/api/libraries/vrcode/forgot", { phone });
  }
}

export function resetPassword(params) {
  return fetch.post("/api/libraries/password/reset", {
    phone: params.phone,
    code: params.code,
